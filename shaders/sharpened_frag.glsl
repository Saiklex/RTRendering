...
void main() {
  ...
  // create final wood colour using details, environment map and shadow factor
  woodColour = 0.65*mix(woodColour,pattern_just_noise,0.1);
  FragColor = mix(woodColour+pattern_splatter,colour,0.05)*shadeFactor*vec4(lightColor, 1.0);
}
